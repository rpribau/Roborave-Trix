...
MotoresRave motores(12, 13, 11, 7, 8, 6, A0, 4, 3); // Motor derecho, motor izquierdo, motor trasero
// viéndolo de frente al robot. Cada uno tiene 3 pines: enable, input1 e input2

Ultrasonicos sensoresUltrasonicos(10, A3, 9, A5); // Sensor ultrasónico izquierdo y derecho. Cada uno tiene
// 2 pines: trig y echo
...
const short seguidorF = 2; // Variable que contiene pin digital 2 de seguidor de línea
...
void setup() {
  ...
  attachInterrupt(seguidorF, apagar, HIGH); // Definición de función attachInterrupt que cuando se 
